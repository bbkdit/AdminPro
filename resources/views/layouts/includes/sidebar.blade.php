<!-- Sidebar -->
@php
    $menus = App\Models\Menu::with('children')->get();
@endphp
            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    @foreach($menus as $menu)
                        <li class="submenu">
                            <a href="{{ $menu->uri }}"  class="{{ Request::is(ltrim($menu->url, '/')) ? 'active' : '' }}"><i class="la la-dashboard"></i> <span> {{ $menu->title }}</span> <span class="menu-arrow"></span></a>
                            @if($menu->children->isNotEmpty())
                                <ul style="display: none;">
                                    @foreach($menu->children as $child)
                                        <li><a href="{{ $child->uri }}" class="{{ Request::is(ltrim($child->url, '/')) ? 'active' : '' }}">{{ $child->title }}</a></li>
                                    @endforeach
                                </ul>
                            @endif
                        </li>
